import cssParser, { Rule, Comment, AtRule } from "css";

var mediaNameGenerator = function (name: string): string {
	return "@media " + name;
};

var nameGenerator = function (name: string): string {
...
var cleanPropertyName = function (name: string): string {
...
export function transform(inputCssText: string) {
	...
	var css = cssParser.parse((inputCssText as unknown) as string);
	var result = {};
